...
class StarlingTest < Minitest::Test
  ...
  def test_starling_with_simple_functions
    ...
    const_42 = k.call(42)  # Always returns 42
    double = ->(x) { x * 2 }
    ...
    # Another example: S (K const_42) I x = K const_42 x (I x) = const_42
    result2 = s.call(k.call(const_42)).call(Smullyan::Birds::I).call("anything")
