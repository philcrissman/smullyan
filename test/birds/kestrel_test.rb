...
class KestrelTest < Minitest::Test
  ...
  def test_kestrel_creates_constant_function
    kestrel = Smullyan::Birds::Kestrel
    const_forty_two = kestrel.call(42)

    # const_forty_two always returns 42, regardless of input
    assert_equal 42, const_forty_two.call(1)
    assert_equal 42, const_forty_two.call('anything')
    assert_equal 42, const_forty_two.call(nil)
    assert_equal 42, const_forty_two.call([1, 2, 3])
  end
